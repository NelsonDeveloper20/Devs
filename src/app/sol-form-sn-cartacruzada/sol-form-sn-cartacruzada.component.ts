...
@Component({
  selector: 'app-sol-form-sn-cartacruzada',
  templateUrl: './sol-form-sn-cartacruzada.component.html',
  styleUrls: ['./sol-form-sn-cartacruzada.component.css']
})
export class SolFormSnCartacruzadaComponent implements OnInit {
  ...
  firstFormGroup = this._formBuilder.group({
    ...
    importe: [{ value: '', disabled: false}],//this.disableCampo }],
    moneda: [{ value: '', disabled: false}],// this.disableCampo }],
